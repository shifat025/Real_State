import team_01 from "./assets/images/team/team-01.png";
import TeamSvg, { Social, TeamSvgTwo } from "./assets/svg/team";

export function TeamMembers({ image, svg, name, designation, social }) {
  return (
